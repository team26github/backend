        ...
        methods: {
            ...
            edit_username() {
                ...
                axios.get(this.path + '/edit', {params: {request: 'username', username: new_username}})
                    .then((res) => {
                        if (res.data.status === 'success') {       
                            axios.post(this.path + '/edit', null, {params: {request: 'username', username: new_username, userid: 1}})
                                .then((res) => {
                                    if (res.data.status === "success") {
            ...
            edit_email() {
                ...
                .then((res) => {
                    if (res.data.status === "success") {
                        axios.post(this.path + '/edit', null, {params: {request: 'email', email: new_email, userid: 1}})
                        .then((res) => {
                            if (res.data.status === "success") {
